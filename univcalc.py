# UNIVERSAL CALCULATOR MAIN FILE

import math
import tkinter.messagebox
from tkinter import *
from lwvconverter import lwvConverter
from progconv import systemConverter
...
# root.iconbitmap(r'E:\PP\Universal-Calculator\Calculator.ico')
...
txtDisplay = Entry(calc, font=('Helvetica', 20, 'bold'), bg='white', fg='black', bd=30,
...
# Here are the rows for the Button of Scientific Calulator.
...
def iExit():
    iExit = tkinter.messagebox.askyesno("Universal Calculator", "Do you want to exit ?")
    if iExit > 0:
        root.destroy()
        return
...
filemenu.add_command(label="Length/Weight/Volume Converter", command=LWVConverter)
filemenu.add_command(label="Num-System Converter", command=BaseConverter)
